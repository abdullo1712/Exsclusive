...
function Home() {
  const [time, setTime] = useState({ days: 3, hours: 23, minutes: 59, seconds: 59 });
          ...
          <div className="flash-sales">
            <div className="flash-sales__left">
              <div className="flash-sales__tag">
                ...
                <p>{searchQuery ? "Qidiruv" : "Kategoriya"}</p>
              </div>
              <h2 className="flash-sales__title">
                {searchQuery ? `"${searchQuery}" natijalari` : "Mahsulotlar"}
              </h2>
            </div>
          </div>
          <Cards1 searchQuery={searchQuery} categoryId={categoryId} />
        </div>
      )}
          ...
          <div className="jbu_reklama">
            <div className="container">
              <div className="ong">
                ...
                <div className="soat">
                  <div className="raqam"><b>23</b><p>Hours</p></div>
                  <div className="raqam"><b>05</b><p>Days</p></div>
                  <div className="raqam"><b>59</b><p>Minutes</p></div>
                  <div className="raqam"><b>35</b><p>Seconds</p></div>
                </div>
